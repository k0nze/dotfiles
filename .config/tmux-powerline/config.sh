...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/q5/_x0s30pj6fsg8sx2tj_ml2mm0000gn/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/konze/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/konze/.mailcheckrc"
# }
